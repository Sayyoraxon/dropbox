...
const Folderwin = ({ foldr, path, dirName, setPut, setDocName, setUser, margin, createWin, setDelFile, setDelDir, setDelPut, setDelId, setDelUser, deletedPut, deletedDir, deletedUser, setViewWin, setUrl }) => {
